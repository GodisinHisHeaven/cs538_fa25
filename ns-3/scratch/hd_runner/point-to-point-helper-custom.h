#ifndef POINT_TO_POINT_HELPER_CUSTOM_H
#define POINT_TO_POINT_HELPER_CUSTOM_H
 ...
 * "mixins".
 */
class PointToPointHelperCustom : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
  public:
    /**
     ...
     * point networks.
     */
    PointToPointHelperCustom();

    ~PointToPointHelperCustom() override
    {
    }
...
template <typename... Ts>
void
PointToPointHelperCustom::SetQueue(std::string type, Ts&&... args)
{
...
#endif /* POINT_TO_POINT_HELPER_CUSTOM_H */
